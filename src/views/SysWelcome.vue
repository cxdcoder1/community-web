<template>
  <el-container>
    ...
    <el-header height="80px">
      ...
      <!-- 顶部标题 -->
      <span style="margin-top: 10px; margin-left: -1300px;">智慧社区</span>
      <el-dropdown>
      ...
      <el-aside width="230px">
        <el-menu
          ...
          <el-submenu :index="item.menuId+''" v-for="item in menuList" :key="item.id" :disabled="item.status == '1'">
            ...
            <el-menu-item :index="'/' + item2.path" v-for="item2 in item.children" :key="item2.menuId" :disabled="item2.status == '1'"
